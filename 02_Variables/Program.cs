...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.Write("Lütfen Aldığınz Bilgisayar Miktarını Giriniz: ");
            //computerCount = int.Parse(Console.ReadLine());

            //Console.Write("Lütfen Aldığınz Sandalye Miktarını Giriniz: ");
            //chairCount = int.Parse(Console.ReadLine());


            //Console.Write("Lütfen Aldığınz Televizyon Miktarını Giriniz: ");
